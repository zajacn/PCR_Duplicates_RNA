...
name=`sed -n ${k}p < /srv/GT/analysis/zajacn/p2220/o31444_G4/G4_p2220_o31444_subsampled_v2/list_of_files`

seqtk sample -s100 /srv/gstore/projects/p2220/G4_FC4_1S11M7B_20230715/${name} 2000000 > $DIR/${name}.subsampled.fastq
