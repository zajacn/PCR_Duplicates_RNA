...
writeData(OUT, sheet = "SuppTbl1", x = tablex)
```
...
pdf("s/Figure2B.pdf", width = 7, height = 7)
...
```{r , echo=FALSE}
addWorksheet(OUT, "SuppTbl4")
writeData(OUT, sheet = "SuppTbl4", x = ezFrame(tptUse), rowNames = TRUE)
