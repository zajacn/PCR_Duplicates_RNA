...
do
	python /usr/local/ngseq/src/Bracken/src/est_abundance.py -i ${i} -k /srv/GT/databases/kraken2/standard_20230605/database100mers.kmer_distrib -l S -t 10 -o ${i}.bracken; #changed to -l G
done
